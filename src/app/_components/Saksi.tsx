            ...
            <div className='container relative'>
                <div className='flex flex-wrap items-center relative'>
                    <div className='w-full p-2 lg:w-1/2 mb-[250px]'>
                        <h2 className='block font-bold text-[#6B0000] text-[39px] leading-tight text-center'>SAKSI</h2>
                        ...
                        <div className='text-center mt-6'>
                            <Link
                                href="https://www.figma.com/design/igfxDBC4VqnzfSJALl50VR/WEB-OSIS-24-25?node-id=2-7&t=Iz3X6NK5HBWLdpYI-0"
                                target="_blank"
                    ...
                    <div className='w-full p-4 lg:w-1/2 flex justify-center relative'>
                        {/* Foto */}
                        <Image src={toa} width={650} height={650} alt='foto' className='max-w-full relative z-0' />
                    </div>
                </div>
            </div>
        </div>
